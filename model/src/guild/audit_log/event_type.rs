...
impl From<u8> for AuditLogEventType {
...
impl From<AuditLogEventType> for u8 {
...
mod tests {
    ...
    #[test]
    fn test_values() {
        assert_eq!(1, u8::from(AuditLogEventType::GuildUpdate));
        assert_eq!(10, u8::from(AuditLogEventType::ChannelCreate));
        assert_eq!(11, u8::from(AuditLogEventType::ChannelUpdate));
        assert_eq!(12, u8::from(AuditLogEventType::ChannelDelete));
        assert_eq!(13, u8::from(AuditLogEventType::ChannelOverwriteCreate));
        assert_eq!(14, u8::from(AuditLogEventType::ChannelOverwriteUpdate));
        assert_eq!(15, u8::from(AuditLogEventType::ChannelOverwriteDelete));
        assert_eq!(20, u8::from(AuditLogEventType::MemberKick));
        assert_eq!(21, u8::from(AuditLogEventType::MemberPrune));
        assert_eq!(22, u8::from(AuditLogEventType::MemberBanAdd));
        assert_eq!(23, u8::from(AuditLogEventType::MemberBanRemove));
        assert_eq!(24, u8::from(AuditLogEventType::MemberUpdate));
        assert_eq!(25, u8::from(AuditLogEventType::MemberRoleUpdate));
        assert_eq!(26, u8::from(AuditLogEventType::MemberMove));
        assert_eq!(27, u8::from(AuditLogEventType::MemberDisconnect));
        assert_eq!(28, u8::from(AuditLogEventType::BotAdd));
        assert_eq!(30, u8::from(AuditLogEventType::RoleCreate));
        assert_eq!(31, u8::from(AuditLogEventType::RoleUpdate));
        assert_eq!(32, u8::from(AuditLogEventType::RoleDelete));
        assert_eq!(40, u8::from(AuditLogEventType::InviteCreate));
        assert_eq!(41, u8::from(AuditLogEventType::InviteUpdate));
        assert_eq!(42, u8::from(AuditLogEventType::InviteDelete));
        assert_eq!(50, u8::from(AuditLogEventType::WebhookCreate));
        assert_eq!(51, u8::from(AuditLogEventType::WebhookUpdate));
        assert_eq!(52, u8::from(AuditLogEventType::WebhookDelete));
        assert_eq!(60, u8::from(AuditLogEventType::EmojiCreate));
        assert_eq!(61, u8::from(AuditLogEventType::EmojiUpdate));
        assert_eq!(62, u8::from(AuditLogEventType::EmojiDelete));
        assert_eq!(72, u8::from(AuditLogEventType::MessageDelete));
        assert_eq!(73, u8::from(AuditLogEventType::MessageBulkDelete));
        assert_eq!(74, u8::from(AuditLogEventType::MessagePin));
        assert_eq!(75, u8::from(AuditLogEventType::MessageUnpin));
        assert_eq!(80, u8::from(AuditLogEventType::IntegrationCreate));
        assert_eq!(81, u8::from(AuditLogEventType::IntegrationUpdate));
        assert_eq!(82, u8::from(AuditLogEventType::IntegrationDelete));
        assert_eq!(83, u8::from(AuditLogEventType::StageInstanceCreate));
        assert_eq!(84, u8::from(AuditLogEventType::StageInstanceUpdate));
        assert_eq!(90, u8::from(AuditLogEventType::StickerCreate));
        assert_eq!(91, u8::from(AuditLogEventType::StickerUpdate));
        assert_eq!(92, u8::from(AuditLogEventType::StickerDelete));
        assert_eq!(100, u8::from(AuditLogEventType::GuildScheduledEventCreate));
        assert_eq!(101, u8::from(AuditLogEventType::GuildScheduledEventUpdate));
        assert_eq!(102, u8::from(AuditLogEventType::GuildScheduledEventDelete));
        assert_eq!(110, u8::from(AuditLogEventType::ThreadCreate));
        assert_eq!(111, u8::from(AuditLogEventType::ThreadUpdate));
        assert_eq!(112, u8::from(AuditLogEventType::ThreadDelete));
        assert_eq!(250, u8::from(AuditLogEventType::Unknown(250)));
    }
}
